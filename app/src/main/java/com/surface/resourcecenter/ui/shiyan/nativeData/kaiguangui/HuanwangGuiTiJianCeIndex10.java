...
public class HuanwangGuiTiJianCeIndex10 extends BaseFragment implements View.OnClickListener {
    ...
    public HuanwangGuiTiJianCeIndex10(){
    ...
    private void initGridLayout(){
        ...
        String[] leftheader = {"仪表室门板","侧板","后侧上部门板","后侧下部门板"};
