...
public class FanghuDengjiIndex9 extends BaseFragment implements View.OnClickListener {
    ...
    private void generateTestData() {
        ...
        xdateInfoList.add("检测部位");
        xdateInfoList.add("技术要求");
        xdateInfoList.add("检测方法");
        xdateInfoList.add("检测结果");
        xdateInfoList.add("");
