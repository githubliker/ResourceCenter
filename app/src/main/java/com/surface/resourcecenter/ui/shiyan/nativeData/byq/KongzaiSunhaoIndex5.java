...
public class KongzaiSunhaoIndex5 extends BaseFragment implements View.OnClickListener {
    ...
    private void generateTestData() {
        ...
        ydataInfoList.add("90%");
        ydataInfoList.add("100%");
        ydataInfoList.add("110%");
