...
public class GaoyaGongpinNaiyaIndex2 extends BaseFragment implements View.OnClickListener {


    private TextView deviceName,deviceTypeId,deviceId,remark,mPicTitle;
    GridLayout mGridLayout;
    public GaoyaGongpinNaiyaIndex2(){
    ...
    private void initGridLayout(){
        ...
        String[] header = {"开关状态","加压部位","接地部位","施加电压值","加压时间","结果"};
        String[] leftheader = {"合闸","合闸","合闸","分闸","分闸","分闸","分闸","分闸","分闸"};
