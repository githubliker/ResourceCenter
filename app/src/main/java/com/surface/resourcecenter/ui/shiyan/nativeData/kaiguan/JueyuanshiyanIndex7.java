...
public class JueyuanshiyanIndex7 extends BaseFragment implements View.OnClickListener {
    ...
    public JueyuanshiyanIndex7(){

    }

    @Override
    protected int getLayoutId() {
        return R.layout.test_duanluqi_jueyuanshiyan;
    }
