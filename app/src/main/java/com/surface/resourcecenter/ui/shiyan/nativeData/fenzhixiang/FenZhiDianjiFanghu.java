package com.surface.resourcecenter.ui.shiyan.nativeData.fenzhixiang;
...
public class FenZhiDianjiFanghu extends BaseFragment implements View.OnClickListener {
    ...
    private void initGridLayout(){
        String[] header = {"测量部位","技术要求值(mΩ)","测量结果（mΩ）"};
        String[] leftheader = {"主接地端与门接地端之间","主接地端与门接地端之间","主接地端与门接地端之间"
        ,"主接地端与安装横梁之间","主接地端与安装板之间","主接地端与辅助电路安装导轨之间","主接地端与电流互感器接地端之间"
        ,"主接地端与柜体接地端之间","主接地端与刀开关接地端之间"};
        ...
        for(int m = 0 ;m<RowNum;m++){
            for(int i = 0;i<ColumnNum;i++){
                ...
                if(i == 1 && m != 0){
                    if(m == 1){
                        rowSpec=GridLayout.spec(m, 9, GridLayout.FILL);
