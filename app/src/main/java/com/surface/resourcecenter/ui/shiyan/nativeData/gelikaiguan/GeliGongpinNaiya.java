...
public class GeliGongpinNaiya extends BaseFragment implements View.OnClickListener {
    ...
    private void initGridLayout(){
        String[] header = {"测试部位","应施电压(峰值)(kV)","修正电压","实施加电压","加压时间(s)","结果"};
        String[] leftheader = {"Aa-F","Bb-F","Cc-F","Dd-F","Ee-F","Ff-F"};
        String[] leftheader1 = {"42","42","42","42","42","42"};
    ...
    private void initGridLayout1(){
        String[] header = {"测试部位","应施电压(峰值)(kV)","修正电压","实施加电压","加压时间(s)","结果"};
        String[] leftheader = {"A-a","B-b","C-c","a-A","b-B","c-C","D-d","E-e","F-f","d-D","e-E","f-F"};
        String[] leftheader1 = {"48","48","48","48","48","48","48","48","48","48","48","48"};
        String[] leftheader2 = {"60","60","60","60","60","60","60","60","60","60","60","60"};
        int ColumnNum = header.length;
        int RowNum = leftheader.length+1;
