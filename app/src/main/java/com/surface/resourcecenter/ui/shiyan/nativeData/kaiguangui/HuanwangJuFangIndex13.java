...
public class HuanwangJuFangIndex13 extends BaseFragment implements View.OnClickListener {


    private TextView deviceName,deviceTypeId,deviceId,remark,mPicTitle;
    GridLayout mGridLayout;
    public HuanwangJuFangIndex13(){
    ...
    private void initGridLayout(){
        ...
        String[] header = {"预加电压（kV）1.3Ur","测量电压（kV）1.1Ur","A","B","C"};
