package com.surface.resourcecenter.ui.shiyan.nativeData.huanwanggui;
...
public class HWJuFang extends BaseFragment implements View.OnClickListener {

    private List<GridLayoutBean> mViewList = new ArrayList<>();
    private LinearLayout mFatherLayout;
    private String[] gridHeader = {"局部放电试验"};
    public HWJuFang(){
    ...
    private void initGridLayout(){
        String[] header = {"测量部位","应施激发\n电压（kV）","修正电压","实施电压","时间（s）","应施测量\n电压（kV）","修正电压","实施电压","时间（s）","结果（pC）"};
        String[] leftheader = {"A-B、C、F","B-A、C、F","C-A、B、F"};
