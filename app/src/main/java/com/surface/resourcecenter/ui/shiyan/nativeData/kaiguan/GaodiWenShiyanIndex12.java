...
public class GaodiWenShiyanIndex12 extends BaseFragment implements View.OnClickListener {
    ...
    public GaodiWenShiyanIndex12(){

    }

    @Override
    protected int getLayoutId() {
        return R.layout.test_gelikaiguan_gaodiwen;
    }
