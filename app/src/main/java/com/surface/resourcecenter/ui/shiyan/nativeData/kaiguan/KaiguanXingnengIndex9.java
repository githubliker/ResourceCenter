...
public class KaiguanXingnengIndex9 extends BaseFragment implements View.OnClickListener {
    ...
    public KaiguanXingnengIndex9(){

    }

    @Override
    protected int getLayoutId() {
        return R.layout.test_gelikaiguan_kaiguanxingneng;
    }
