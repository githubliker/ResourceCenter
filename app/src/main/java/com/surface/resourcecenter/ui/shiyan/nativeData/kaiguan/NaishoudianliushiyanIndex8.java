...
public class NaishoudianliushiyanIndex8 extends BaseFragment implements View.OnClickListener {
    ...
    public NaishoudianliushiyanIndex8(){

    }

    @Override
    protected int getLayoutId() {
        return R.layout.test_gelikaiguan_naishoushiyan;
    }
