...
public class DuanziJingfuzaiIndex13 extends BaseFragment implements View.OnClickListener {


    private TextView deviceName,deviceTypeId,deviceId,remark,mPicTitle;
    GridLayout mGridLayout;
    public DuanziJingfuzaiIndex13(){
    ...
    private void initGridLayout(){
        ...
        String[] header = {"序号","操作方式及要求","操作次数","测试结果"};
