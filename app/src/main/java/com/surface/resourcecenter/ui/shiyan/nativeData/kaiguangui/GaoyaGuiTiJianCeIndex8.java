...
public class GaoyaGuiTiJianCeIndex8 extends BaseFragment implements View.OnClickListener {
    ...
    private void initGridLayout(){
        ...
        String[] leftheader = {"柜体尺寸，宽/深/高，mm","仪表室门板","断路器门板","电缆室门板","侧板","后侧上部门板","后侧下部门板","柜体板材","主回路母线","分支母线","接地排"};
