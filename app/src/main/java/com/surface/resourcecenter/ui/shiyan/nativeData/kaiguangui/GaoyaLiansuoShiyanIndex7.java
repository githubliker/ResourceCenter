...
public class GaoyaLiansuoShiyanIndex7 extends BaseFragment implements View.OnClickListener {


    private TextView deviceName,deviceTypeId,deviceId,remark,mPicTitle;
    GridLayout mGridLayout;
    public GaoyaLiansuoShiyanIndex7(){
    ...
    private void initGridLayout(){
        ...
        String[] header = {"序号","操作步骤及要求","测试结果"};
        String[] leftheader = {"1","2","3"};
        String[] leftheader1 = {"应具有可靠的“五防”功能","所有原件动作和指示应正确对应","连锁装置应能正常操作"};
