...
public class ZhushangJixieTexing extends BaseFragment implements View.OnClickListener {
    ...
    private void initGridLayout(){
        ...
        String[] leftheader1 = {"25-60","≤2.0","20-55","≤2.0","≤2.0"};
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.test_refresh:
                ...
                TestItemsBean bean =getTestItems(ZhuShangShiyanItem.gyjx);
    ...
    private void saveShiyanData(boolean isChecked){
        ...
        try {
            ...
            for(int i = 0;i<results.size();i++){
                json.put(ZhuShangShiyanItem.gyjx1_data[i],results.get(i).getText().toString());
            }
            for(int i = 0;i<results1.size();i++){
                json.put(ZhuShangShiyanItem.gyjx_data[i],results1.get(i).getText().toString());
...
//                Log.e(TAG,"mDataCallback result "+response.get().toString());
    ...
    private void updateShiyanData(String result){
        ...
        try {
            ...
            for(int i = 0;i<ZhuShangShiyanItem.gyjx1_data.length;i++){
                String data = jsonObject.getString(ZhuShangShiyanItem.gyjx1_data[i]);
                results.get(i).requestFocus();
                results.get(i).setText(data);
            }
            for(int i = 0;i<ZhuShangShiyanItem.gyjx_data.length;i++){
                String data = jsonObject.getString(ZhuShangShiyanItem.gyjx_data[i]);
